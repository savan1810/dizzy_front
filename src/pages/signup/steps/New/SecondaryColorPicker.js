...
const SecondaryColorPicker = ({ setStep, setUser, user }) => {
    ...
    return (
        <div className="h-screen flex flex-col justify-between relative">
            <div className="flex-grow flex justify-center items-center">
                <div className='space-y-[50px]'>
                    <div className="color-picker w-[300px] space-y-[50px]">
                        <h3 className='font-default w-[300px] text-start'>Select secondary color</h3>
                    ...
                    <div className="font-default flex">
                        ...
                        <div className="cursor-pointer" onClick={() => setStep(20)}>
                            Go back
                        </div>
                    </div>
                </div>
            ...
            <FooterComment comment={`This will be used as the secondary color in your dizee brand kit, used for fonts and buttons`} />
        </div>
    );
};
