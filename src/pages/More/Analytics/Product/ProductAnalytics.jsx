...
export default function ProductAnalytics() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                await getDataAPI(`analytics/get-product-analytics?filter=${filter}`, token).then((res) => {
        ...
        <LayoutHeader>
            <div className="w-[390px] flex flex-col justify-start items-center relative z-[0]">
                <div className='px-4 my-[50px]  flex w-full justify-between'>
                    <p className='text-white'>Product analytics</p>
                ...
                <div className='px-4 my-[50px] flex w-full justify-between'>
                    ...
                    <p className='text-white cursor-pointer' onClick={() => navigate('/more/analytics/filter', { state: { path: '/more/analytics/product' } })}>Filter</p>
                </div>
