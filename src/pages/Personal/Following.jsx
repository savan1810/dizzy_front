...
import { follow_unfollow_auth_thunk, getTopUserThunk, getUserFollowingListThunk } from '../../store/auth/authThunk';
...
export default function Following() {
    ...
    // Fetch top users
    useEffect(() => {
        dispatch(getUserFollowingListThunk({ username: userArticle?.username, size: 7 })).then((res) => {
