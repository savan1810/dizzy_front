...
import { addMusicToSectionThunk, addProductToSectionThunk, getMusicThunk, getProductThunk } from '../../../../../store/addsection/addsectionThunk';
...
export default function ImportLinkProduct() {
    ...
    const handleAddProduct = async () => {
        ...
        let payload = {
            ...
            links: [
                {
                    source: previousSource ? previousSource : name,
                    url: link
                }
            ]
        }
