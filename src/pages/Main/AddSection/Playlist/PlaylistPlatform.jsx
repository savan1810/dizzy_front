...
import { MANUAL_MUSIC_PLATFORMS, PLAYLIST_PLATFORMS, SOCIAL_PLATFORMS_FOR_FEED, VIDEO_PLATFORMS } from '../../../../constants/constants'
import { useNavigate } from 'react-router';
import VideoPlatform from '../../../../components/AddSection/Video/VideoPlatform';
import SelectPlaylist from '../../../../components/AddSection/Playlist/SelectPlaylist';

export default function PlaylistPlatform() {
    ...
    return (
        <LayoutHeader>
            <div className="w-[350px] sm:w-[390px] flex flex-col justify-start items-center relative z-[0]">
                ...
                {
                    PLAYLIST_PLATFORMS.map((item, index) => (
                        <SelectPlaylist
                            txt={item.label}
                            key={index}
                            value={item.value}
