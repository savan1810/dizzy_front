...
import { deleteMusicThunk, deleteVideoThunk } from '../../../store/addsection/addsectionThunk';
import { clearAlerts } from '../../../store/alert/alertSlice';

export default function VideoOverlay({ isOverlayVisible, setOverlayVisible, avtarForBackend }) {
    ...
    const handleDeleteClick = () => {
        ...
        dispatch(deleteVideoThunk({ token: token, avatar: avtarForBackend }));
        setOverlayVisible(false);
    };
