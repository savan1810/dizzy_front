...
import { deleteEventThunk, deleteMusicThunk, deletePlaylistThunk, deleteProductThunk, deleteVideoThunk } from '../../../store/addsection/addsectionThunk';
import { clearAlerts } from '../../../store/alert/alertSlice';

export default function PlaylistOverlay({ isOverlayVisible, setOverlayVisible, avtarForBackend }) {
    ...
    const handleDeleteClick = () => {
        ...
        dispatch(deletePlaylistThunk({ token: token, avatar: avtarForBackend }));
        setOverlayVisible(false);
    };
