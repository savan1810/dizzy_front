...
import { setWholeFocusProduct } from '../../../store/focuspage/focuspageSlice';
import CrossArrow from '../../../svg/CrossArrow';

export default function ProductRedirectCard({ txt, link, dotimgclss, item }) {
    ...
    return (
        <div className='p-4 py-6 flex w-full justify-between items-center'>
            ...
            <button onClick={() => {
                dispatch(setWholeFocusProduct(item))
                navigate(link)
            }} >
